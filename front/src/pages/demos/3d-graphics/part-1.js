...
slider({
  ...
  value: 1.2,
  precision: 3,
  format: v => `${Math.round(v / PI * 1000) / 1000 } Pi / ${v} rad`,
  //format: v => `${Math.round(v/2 / PI) % 2} Pi`,
  description: "Двигайте слайдер для анимации изображения"
})
);}),
      node_id: 221
    },
