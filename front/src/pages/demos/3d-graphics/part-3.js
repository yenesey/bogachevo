...
#### (Продолжение [части 2](/demos/3d-graphics/part-2))`
);}),
      node_id: 21
    },
    {
...
Нам повезло: раз мы сами обсчитывали вершины для тора в [части 2](/demos/3d-graphics/part-2)) с помощью вложенных циклов, теперь мы можем воспользоваться тем же самым алгоритмом. Двигаясь по пути, по которому создавались вершины, можно просто отметить близлежащие точки как грани:`
);}),
      node_id: 130
    },
    {
...
`
    ...
    },
    {
      inputs: ["md"],
      value: (function(md){return(
md`[ *<--* Предыдущая часть](/demos/3d-graphics/part-2)`
);}),
      node_id: 736
    },
    {
