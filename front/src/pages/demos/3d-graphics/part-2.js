...
#### (Продолжение [части 1](/demos/3d-graphics/part-1))`
);}),
      node_id: 33
    },
    {
...
Тороид, или тор очень удачная фигура для экспериментов. Во-первых его форма - "бублика", намного интереснее, чем просто куб, или пирамида. Во-вторых тор, как вы увидите, весь просто "соткан" из вращений, которые мы прошли в [части 1](/demos/3d-graphics/part-1).
...
md`Очевидно, что между точками довольно много свободного места, и это выглядит не слишком красиво. Как решить эту проблему? Можно сделать больше точек, но каждую точку придется обсчитывать и выделять под нее память. Более оптимальным решением будет покрыть поверхность фигуры гранями. Этим мы и займемся в следующей части.`
    ...
    },
    {
      inputs: ["md"],
      value: (function(md){return(
md`[ *<--* Предыдущая часть](/demos/3d-graphics/part-1) -|- [Следующая часть *-->*](/demos/3d-graphics/part-3)`
);}),
      node_id: 818
    },
    {
